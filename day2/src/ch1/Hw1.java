...
public class Hw1 {
	...
	public static void main(String[] args) {
		...
		// 위에서 같은 이름의 변수 a와 b를 사용했기 때문에 선언 불가 -> 기존 값 변경
		a = 5;
		b = 7;
		System.out.println("a > b = " + (a > b));
		System.out.println("a < b = " + (a < b));
